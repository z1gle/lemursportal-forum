...
<c:set var="firstUrl" value="${baseUrl}pageDocument=1" />
<c:set var="lastUrl" value="${baseUrl}pageDocument=${totalPages}" />
<c:set var="prevUrl" value="${baseUrl}pageDocument=${currentPage - 1}" />
<c:set var="nextUrl" value="${baseUrl}pageDocument=${currentPage + 1}" />
...
<ul class="pagination">
	...
	<c:forEach var="i" begin="${begin}" end="${end}">
		<c:set var="pageUrl" value="${baseUrl}pageDocument=${i}" />
		<c:choose>
