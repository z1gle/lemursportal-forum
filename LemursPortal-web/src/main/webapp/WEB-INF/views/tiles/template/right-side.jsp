    ...
    <c:forEach items="${topDocuments}" var="topDocument">
       ...
       <c:url var="videoPageUrl" value="/documents#tab-item-2"/>
        ...
        <c:url var="videoPageUrl" value="/documents#tab-item-1"/>
			<a  href="${videoPageUrl}">
        	<img src="${resourcesPath}/profil/blanc.png" style="background-image: url('${resourcesPath}/upload/${topDocument.filename}'); background-size: cover;background-position: 50% 25%;" alt=""/></a>
        </c:if>
